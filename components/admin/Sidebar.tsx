...
import { FaUsers, FaBook, FaCalendarAlt, FaFileAlt, FaCog } from 'react-icons/fa';
  ...
  return (
    <div className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200">
        <Link href="/logout" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-background-secondary text-text hover:text-primary">
